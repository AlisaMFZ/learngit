...
function Ajv(opts) {
  ...
  if ((0, _typeof3.default)(opts.meta) == 'object') addMetaSchema(opts.meta);
  addInitialSchemas();
  ...
  function defaultMeta() {
    ...
    self._opts.defaultMeta = (typeof meta === 'undefined' ? 'undefined' : (0, _typeof3.default)(meta)) == 'object' ? meta.id || meta : self._opts.v5 ? v5.META_SCHEMA_ID : META_SCHEMA_ID;
  ...
  function getSchema(keyRef) {
    ...
    switch (typeof schemaObj === 'undefined' ? 'undefined' : (0, _typeof3.default)(schemaObj)) {
      case 'object':
        return schemaObj.validate || _compile(schemaObj);
      case 'string':
  ...
  function removeSchema(schemaKeyRef) {
    ...
    switch (typeof schemaKeyRef === 'undefined' ? 'undefined' : (0, _typeof3.default)(schemaKeyRef)) {
      case 'undefined':
  ...
  function _addSchema(schema, skipValidation, meta, shouldAddSchema) {
    if ((typeof schema === 'undefined' ? 'undefined' : (0, _typeof3.default)(schema)) != 'object') throw new Error('schema should be object');
...
//# sourceMappingURL=ajv-compiled.js.map