...
module.exports = function generate_properties(it, $keyword) {
  ...
  var $schemaKeys = (0, _keys2.default)($schema || {}),
      ...
      $pPropertyKeys = (0, _keys2.default)($pProperties),
      $aProperties = it.schema.additionalProperties,
      $someProperties = $schemaKeys.length || $pPropertyKeys.length,
      $noAdditional = $aProperties === false,
      $additionalIsSchema = (typeof $aProperties === 'undefined' ? 'undefined' : (0, _typeof3.default)($aProperties)) == 'object' && (0, _keys2.default)($aProperties).length,
  ...
  if (it.opts.v5) {
    var $pgProperties = it.schema.patternGroups || {},
        $pgPropertyKeys = (0, _keys2.default)($pgProperties);
  }
