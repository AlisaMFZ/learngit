...
RequestSigner.prototype.canonicalString = function () {
  ...
  if (query) {
    queryStr = encodeRfc3986(querystring.stringify((0, _keys2.default)(query).sort().reduce(function (obj, key) {
      if (!key) return obj;
...
RequestSigner.prototype.canonicalHeaders = function () {
  ...
  return (0, _keys2.default)(headers).sort(function (a, b) {
...
RequestSigner.prototype.signedHeaders = function () {
  return (0, _keys2.default)(this.request.headers).map(function (key) {
