...
define(function (require, exports, module) {
  ...
  function assertMapping(generatedLine, generatedColumn, originalSource, originalLine, originalColumn, name, map, assert, dontTestGenerated, dontTestOriginal) {
    if (!dontTestOriginal) {
      ...
      assert.equal(origMapping.name, name, 'Incorrect name, expected ' + (0, _stringify2.default)(name) + ', got ' + (0, _stringify2.default)(origMapping.name));
      assert.equal(origMapping.line, originalLine, 'Incorrect line, expected ' + (0, _stringify2.default)(originalLine) + ', got ' + (0, _stringify2.default)(origMapping.line));
      assert.equal(origMapping.column, originalColumn, 'Incorrect column, expected ' + (0, _stringify2.default)(originalColumn) + ', got ' + (0, _stringify2.default)(origMapping.column));
      ...
      assert.equal(origMapping.source, expectedSource, 'Incorrect source, expected ' + (0, _stringify2.default)(expectedSource) + ', got ' + (0, _stringify2.default)(origMapping.source));
    }
    ...
    if (!dontTestGenerated) {
      ...
      assert.equal(genMapping.line, generatedLine, 'Incorrect line, expected ' + (0, _stringify2.default)(generatedLine) + ', got ' + (0, _stringify2.default)(genMapping.line));
      assert.equal(genMapping.column, generatedColumn, 'Incorrect column, expected ' + (0, _stringify2.default)(generatedColumn) + ', got ' + (0, _stringify2.default)(genMapping.column));
    }
  }
