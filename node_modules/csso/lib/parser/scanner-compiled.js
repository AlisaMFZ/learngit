...
var SYMBOL_CATEGORY_LENGTH = Math.max.apply(null, (0, _keys2.default)(PUNCTUATION)) + 1;
var SYMBOL_CATEGORY = new Uint32Array(SYMBOL_CATEGORY_LENGTH);
var IS_PUNCTUATOR = new Uint32Array(SYMBOL_CATEGORY_LENGTH);

// fill categories
(0, _keys2.default)(PUNCTUATION).forEach(function (key) {
...
//# sourceMappingURL=scanner-compiled.js.map