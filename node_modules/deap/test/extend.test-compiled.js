...
describe('shallow extend', function () {
	...
	it('should only alter first param', function () {
		...
		assert.sameMembers((0, _keys2.default)(result), ['doom', 'burp', 'grr']);
	...
	it('should not pick up non-enumberable properties', function () {
		...
		assert.equal((0, _keys2.default)(result).length, 0);
		assert.equal((0, _getOwnPropertyNames2.default)(result).length, 0);
	});
});
...
//# sourceMappingURL=extend.test-compiled.js.map