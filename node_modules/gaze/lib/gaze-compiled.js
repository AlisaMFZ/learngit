...
function Gaze(patterns, opts, done) {
  ...
  this._watched = (0, _create2.default)(null);

  // Store watchers
  this._watchers = (0, _create2.default)(null);

  // Store watchFile listeners
  this._pollers = (0, _create2.default)(null);

  // Store patterns
  this._patterns = [];

  // Cached events for debouncing
  this._cached = (0, _create2.default)(null);
...
Gaze.prototype.emit = function () {
  ...
  if (e === 'added') {
    (0, _keys2.default)(this._cached).forEach(function (oldFile) {
...
Gaze.prototype.close = function (_reset) {
  ...
  (0, _keys2.default)(self._watchers).forEach(function (file) {
    self._watchers[file].close();
  });
  self._watchers = (0, _create2.default)(null);
  (0, _keys2.default)(this._watched).forEach(function (dir) {
    self._unpollDir(dir);
  });
  if (_reset) {
    self._watched = (0, _create2.default)(null);
    setTimeout(function () {
      self.emit('end');
...
Gaze.prototype.relative = function (dir, unixify) {
  var self = this;
  var relative = (0, _create2.default)(null);
...
Gaze.prototype._initWatched = function (done) {
  var self = this;
  var cwd = this.options.cwd || process.cwd();
  var curWatched = (0, _keys2.default)(self._watched);
...
//# sourceMappingURL=gaze-compiled.js.map