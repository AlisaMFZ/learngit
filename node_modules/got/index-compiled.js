	...
	var get = function get(opts) {
		...
		var req = fn.request(opts, function (res) {
			...
			if (isRedirect(statusCode) && opts.followRedirect && 'location' in res.headers && (opts.method === 'GET' || opts.method === 'HEAD')) {
				...
				var redirectOpts = (0, _assign2.default)({}, opts, urlLib.parse(redirectUrl));
...
function normalizeArguments(url, opts) {
	if (typeof url !== 'string' && (typeof url === 'undefined' ? 'undefined' : (0, _typeof3.default)(url)) !== 'object') {
		throw new Error('Parameter `url` must be a string or object, not ' + (typeof url === 'undefined' ? 'undefined' : (0, _typeof3.default)(url)));
	}
	...
	opts.headers = (0, _assign2.default)({
	...
	if (body) {
		if (typeof body !== 'string' && !(body !== null && (typeof body === 'undefined' ? 'undefined' : (0, _typeof3.default)(body)) === 'object')) {
		...
		} else if (body !== null && (typeof body === 'undefined' ? 'undefined' : (0, _typeof3.default)(body)) === 'object' && !Buffer.isBuffer(body) && !isStream(body)) {
...
helpers.forEach(function (el) {
	got[el] = function (url, opts) {
		return got(url, (0, _assign2.default)({}, opts, { method: el }));
	};
});
...
try {
	var _loop = function _loop() {
		...
		got.stream[el] = function (url, opts) {
			return got.stream(url, (0, _assign2.default)({}, opts, { method: el }));
		};
	};

	for (var _iterator = (0, _getIterator3.default)(helpers), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
		_loop();
	}
} catch (err) {
