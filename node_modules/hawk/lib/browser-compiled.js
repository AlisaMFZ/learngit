...
hawk.client = {
    ...
    */
    ...
    header: function header(uri, method, options) {
        ...
        if (!uri || typeof uri !== 'string' && (typeof uri === 'undefined' ? 'undefined' : (0, _typeof3.default)(uri)) !== 'object' || !method || typeof method !== 'string' || !options || (typeof options === 'undefined' ? 'undefined' : (0, _typeof3.default)(options)) !== 'object') {
    ...
    */
    ...
    bewit: function bewit(uri, options) {
        ...
        if (!uri || typeof uri !== 'string' || !options || (typeof options === 'undefined' ? 'undefined' : (0, _typeof3.default)(options)) !== 'object' || !options.ttlSec) {
    ...
    */
    ...
    message: function message(host, port, _message, options) {
        ...
        if (!host || typeof host !== 'string' || !port || typeof port !== 'number' || _message === null || _message === undefined || typeof _message !== 'string' || !options || (typeof options === 'undefined' ? 'undefined' : (0, _typeof3.default)(options)) !== 'object') {
...
hawk.internals.LocalStorage = function () {
    ...
    this.setItem = function (key, value) {
        ...
        this.length = (0, _keys2.default)(this._cache).length;
    };
    ...
    this.key = function (i) {
        ...
        return (0, _keys2.default)(this._cache)[i || 0];
    };
};
