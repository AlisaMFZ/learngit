...
describe('clone()', function () {
    ...
    it('should not convert undefined properties to null', function (done) {
        ...
        expect((0, _typeof3.default)(b.something)).to.equal('undefined');
        done();
    });
    ...
    it('clones circular reference', function (done) {
        ...
        var b = Hoek.clone(x);
        expect((0, _keys2.default)(b.y)).to.deep.equal((0, _keys2.default)(x));
    ...
    it('should copy a buffer', function (done) {
        ...
        expect((0, _stringify2.default)(copiedTls.key)).to.equal((0, _stringify2.default)(tls.key));
        expect(Buffer.isBuffer(copiedTls.cert)).to.equal(true);
        expect((0, _stringify2.default)(copiedTls.cert)).to.equal((0, _stringify2.default)(tls.cert));
        done();
    });
    ...
    it('clones an object where getOwnPropertyDescriptor returns undefined', function (done) {
        ...
        var oldGetOwnPropertyDescriptor = _getOwnPropertyDescriptor2.default;
        var obj = { a: 'b' };
...
describe('deepEqual()', function () {
    ...
    it('compares plain objects', function (done) {
        ...
        var a = (0, _create2.default)(null);
        var b = (0, _create2.default)(null);
...
describe('reach()', function () {
    ...
    it('returns function member', function (done) {
        ...
        expect((0, _typeof3.default)(Hoek.reach(obj, 'i'))).to.equal('function');
        done();
    });
...
describe('ignore()', function () {
    ...
    it('exists', function (done) {
        ...
        expect((0, _typeof3.default)(Hoek.ignore)).to.equal('function');
        done();
    });
});
...
describe('inherits()', function () {
    ...
    it('exists', function (done) {
        ...
        expect((0, _typeof3.default)(Hoek.inherits)).to.equal('function');
        done();
    });
});
...
describe('format()', function () {
    ...
    it('exists', function (done) {
        ...
        expect((0, _typeof3.default)(Hoek.format)).to.equal('function');
        done();
    });
