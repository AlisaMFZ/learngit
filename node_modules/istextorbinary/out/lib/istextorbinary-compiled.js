...
(function () {
  ...
  isTextOrBinary = {
    isTextSync: function isTextSync(filename, buffer) {
    ...
    isText: function isText(filename, buffer, next) {
      var result;
    ...
    isBinarySync: function isBinarySync(filename, buffer, next) {
      var result;
      result = isTextOrBinary.isTextSync(filename, buffer);
      if (result instanceof Error) {
        return result;
    ...
    isBinary: function isBinary(filename, buffer, next) {
    ...
    getEncodingSync: function getEncodingSync(buffer, opts) {
    ...
    getEncoding: function getEncoding(buffer, opts, next) {
      var result;
...
//# sourceMappingURL=istextorbinary-compiled.js.map