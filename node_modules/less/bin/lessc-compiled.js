...
(function () {
        ...
        switch (arg) {
            ...
            default:
                ...
                if (plugin) {
                    ...
                    console.error("Unable to interpret argument " + arg + " - if it is a plugin (less-plugin-" + arg + "), make sure that it is installed under or at" + " the same level as less");
                    process.exitCode = 1;
                }
                break;
        }
    ...
    if (!sourceMapFileInline) {
        var writeSourceMap = function writeSourceMap(output, onDone) {
            output = output || "";
...
//# sourceMappingURL=lessc-compiled.js.map