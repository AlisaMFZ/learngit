...
module.exports = function () {
    ...
    var globals = (0, _keys2.default)(global);
    ...
    function globalReplacements(input, directory) {
        ...
        return input.replace(/\{path\}/g, p).replace(/\{pathesc\}/g, pathesc).replace(/\{pathimport\}/g, pathimport).replace(/\{pathimportesc\}/g, pathimportesc).replace(/\r\n/g, '\n');
    }

    function checkGlobalLeaks() {
        return (0, _keys2.default)(global).filter(function (v) {
    ...
    function runTestSet(options, foldername, verifyFunction, nameModifier, doReplacements, getFilename) {
        var options2 = options ? JSON.parse((0, _stringify2.default)(options)) : {};
...
//# sourceMappingURL=less-test-compiled.js.map

//# sourceMappingURL=less-test-compiled-compiled.js.map