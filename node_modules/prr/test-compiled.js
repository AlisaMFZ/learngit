...
test('test prr(o, key, value) form', function (t) {
  ...
  t.deepEqual((0, _getOwnPropertyDescriptor2.default)(o, 'foo'), {
    enumerable: false,
    configurable: false,
    writable: false,
    value: 'bar'
...
test('test multiple key:value pairs', function (t) {
  ...
  t.deepEqual(o.obj, { o: 'o' }, 'correctly set property');['one', 'two', 'obj'].forEach(function (p) {
    t.deepEqual((0, _getOwnPropertyDescriptor2.default)(o, p), {
      enumerable: false,
      configurable: false,
      writable: false,
...
test('test descriptor options', function (t) {
  ...
  t.deepEqual((0, _getOwnPropertyDescriptor2.default)(o, 'foo2'), {
    enumerable: true,
    configurable: true,
    writable: false,
    value: 'bar2'
  ...
  t.deepEqual((0, _getOwnPropertyDescriptor2.default)(o, 'foo3'), {
    enumerable: true,
    configurable: true,
    writable: true,
    value: 'bar3'
