...
function WebSocketServer(options, callback) {
  ...
  if (options.isDefinedAndNonNull('port')) {
    ...
    if (options.value.path) {
      ...
      if ((0, _typeof3.default)(this._server._webSocketPaths) !== 'object') {
...
WebSocketServer.prototype.close = function (callback) {
  ...
  if (this.path && this._server._webSocketPaths) {
    ...
    if ((0, _keys2.default)(this._server._webSocketPaths).length == 0) {
...
function handleHybiUpgrade(req, socket, upgradeHead, cb) {
  ...
  var completeHybiUpgrade2 = function completeHybiUpgrade2(protocol) {
    ...
    if ((0, _keys2.default)(extensions).length) {
      var serverExtensions = {};
      (0, _keys2.default)(extensions).forEach(function (token) {
